...
export { HttpTransport, createHttpTransport, isHttpTransport, } from './transports/http-transport.js';
// ============================================================================
// CONVENIENCE HELPERS
// ============================================================================
import { MessageFactory } from './core/message.js';
import { validateMessage as validateMessageFromTypes } from './types/index.js';
export const validateMessageSafe = (message) => {
    try {
        return validateMessageFromTypes(message);
    }
    catch {
        return false;
    }
