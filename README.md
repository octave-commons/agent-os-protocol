<!-- READMEFLOW:BEGIN -->
# @promethean-os/agent-os-protocol

Agent OS Core Message Protocol - Unified messaging protocol for agent communication
...
```bash
pnpm -w add -D @promethean-os/agent-os-protocol
```
